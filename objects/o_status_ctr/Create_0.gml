...
ds_menu_audio = create_menu_page(
	["MASTER",     menu_element_type_p.slider, change_volume, 1, [0,1]],
	["MUSIC",      menu_element_type_p.slider, change_volume, .85, [0,1]],
	["SFX",		   menu_element_type_p.slider, change_volume, .85, [0,1]],
	["BACK",       menu_element_type_p.page_transfer, pause_menu_page.settings]
);
